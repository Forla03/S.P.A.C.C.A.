...
public class GladioDiMarte extends CartaEquipaggiamento{
	
	public GladioDiMarte(String nome, TipiMitologie mitologia, RaritaCartaGiocabile rarita, String effetto, Image immagine) {

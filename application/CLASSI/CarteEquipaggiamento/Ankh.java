...
public class Ankh extends CartaEquipaggiamento{
	
	public Ankh(String nome, TipiMitologie mitologia, RaritaCartaGiocabile rarita, String effetto, Image immagine) {
        super(nome, mitologia, rarita, effetto, immagine);
    }
	
	public void effetto(Utente u,CartaPersonaggio c) {
		int x=Math.round(c.getPsAttuali()/2);
		c.addAtt(x);
		attAggiuntoPrec=x;
		psAggiuntiPrec=0;
	}	

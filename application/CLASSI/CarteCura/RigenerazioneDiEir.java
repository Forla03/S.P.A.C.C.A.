...
public class RigenerazioneDiEir extends CartaCura{
	
	public RigenerazioneDiEir(String nome, TipiMitologie mitologia, RaritaCartaGiocabile rarita, String effetto, Image immagine) {
        super(nome, mitologia, rarita, effetto, immagine);
    }
	
	public void effetto(Utente u,CartaPersonaggio c) {
		int x=(int)Math.round(c.getPsAttuali()*1.5);
		c.addPs(x);
	}

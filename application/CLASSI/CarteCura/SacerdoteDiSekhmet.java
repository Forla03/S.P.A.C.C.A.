...
public class SacerdoteDiSekhmet extends CartaCura{
	
	public SacerdoteDiSekhmet(String nome, TipiMitologie mitologia, RaritaCartaGiocabile rarita, String effetto, Image immagine) {

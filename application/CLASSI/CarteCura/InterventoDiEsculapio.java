...
public class InterventoDiEsculapio extends CartaCura{
	
	public InterventoDiEsculapio(String nome, TipiMitologie mitologia, RaritaCartaGiocabile rarita, String effetto, Image immagine) {

...
public class CultoDiSalus extends CartaCura{
	
	public CultoDiSalus(String nome, TipiMitologie mitologia, RaritaCartaGiocabile rarita, String effetto, Image immagine) {
